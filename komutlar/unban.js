...
module.exports.run = async (client, message, args) => {
 if(!message.member.roles.cache.get(ayarlar.BanYetkilisi) && !message.member.hasPermission('781466094903885864')) return message.channel.send('Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.')
...
.setDescription(`**• Utku Moderation ! \n\n• Banı Kaldıran Yetkili :`+ message.member +`\n• Banı Kaldırılan Kullanıcı  \<a:yuklen:782271167909462037>  : <@${unbanid}>**`)
.setTimestamp()
