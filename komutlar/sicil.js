...
exports.run = async(client, message, args) => {    
 if(!message.member.roles.cache.some(r => ["781466094903885864"].includes(r.id))) //
    return message.reply("Bu Komutu Kullanmak İçin Yeterli Yetkin Bulunmamakta \<a:hayir:782879758760280074>  !")
  //------------------------------------------------KAYITLAR-----------------------------------------------\\    STG   
