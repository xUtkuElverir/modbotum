...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◆◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\    
 ...
 if(!message.member.roles.cache.get(ayarlar.MuteYetkilisi) && !message.member.hasPermission('781466111186174003')) return message.channel.send('Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.')
          ...
          try {
            client.channels.cache.get(ayarlar.MuteKanal).send(
              ...
              .setAuthor(message.author.username, message.author.avatarURL ({ dynamic: true}))
                .setColor(`GREEN`)
                .setDescription(`<@${kişi.id}> (\`${kişi.id}\`) üye metin kanallarında susturuldu <@&781466111186174003> kullanıcının rollerini almayı unutma \<a:yldz:782269240953798667> .
...
• Sebep: \`${sebep}\``)
            ...
            message.react('\<a:yuklen:782271167909462037> ')
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◆◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\ 
          ...
          setTimeout(async function() {
            muted.roles.remove(
              ...
              new Discord.MessageEmbed()
              .setColor('#494459')
              .setDescription(`<@${kişi.id}> (\`${kişi.id}\`) üyesinin metin kanallarında susturulması sonlandı <@&781466111186174003> kullanıcının rollerini vermeyi unutma \<a:yldz:782269240953798667> .
